    ...
    AppModule = __decorate([
        core_1.NgModule({
                ...
                router_1.RouterModule.forRoot([
                    ...
                    { path: 'Kontakt', component: components_2.ContactComponent },
                    {
                        ...
                        children: [
                            ...
                            { path: 'Rezepte/Erstellen', component: components_2.CmsRecipeEditComponent, canActivate: [services_1.AccountService], data: { roles: ['author', 'admin'] } },
                            ...
                            { path: 'Zutaten', component: components_2.CmsIngredientEditComponent, canActivate: [services_1.AccountService], data: { roles: ['author', 'admin'] } },
            ...
            declarations: [
                ...
                components_2.CmsIngredientEditComponent,
