...
var NavigationDesktopDirective = (function () {
    ...
    NavigationDesktopDirective = __decorate([
        core_1.Component({
            selector: 'navigationdesktop-directive',
            templateUrl: '/views/directives/navigation/NavigationDesktop.html'
        }), 
        __metadata('design:paramtypes', [router_1.Router, services_1.AccountService, services_1.NavigationService, services_1.SearchService])
