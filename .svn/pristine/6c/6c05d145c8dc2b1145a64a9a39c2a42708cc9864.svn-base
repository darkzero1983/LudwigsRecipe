...
var CmsRecipeOverviewComponent = (function () {
    ...
    CmsRecipeOverviewComponent.prototype.deleteRecipe = function (id) {
        var _this = this;
        this.cmsService.deleteRecipe(id).then(function (recipes) { return _this.loadRecipes(_this.currentPage); });
    };
